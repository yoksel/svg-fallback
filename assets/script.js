...
function createIconsList(folder,items) {
    ...
    for (var i = 0; i < items.length; i++) {
        ...
        var span_class = folder + " "+ folder +"--" + iconId;

        icons += "<li class=\"icons-list__item\">";
        icons += "<h5 class=\"icons-list__title\">#" + fullIconId + "</h5>";

        if (svgIds[fullIconId]){
            icons += "<span class=\"" + span_class + "\"><svg><use xlink:href=\"#" + fullIconId + "\"></svg></span>";
        }

        icons += "<span class=\"ie8\"><span class=\"" + span_class + "\"></span></span>";
        icons += "</li>";
    }
